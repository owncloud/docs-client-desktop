...
Antora-based documentation component for the ownCloud Desktop synchronization client. This repository holds the AsciiDoc source files covering installation, configuration, and usage of the desktop client across Windows, macOS, and Linux, published to [doc.owncloud.com](https://doc.owncloud.com).
...
This is a content component for the [ownCloud docs](https://github.com/owncloud/docs) Antora build. The desktop client source code lives at [owncloud/client](https://github.com/owncloud/client). Published documentation is available at [doc.owncloud.com](https://doc.owncloud.com).

## Community & Support

**[Star](https://github.com/owncloud/docs-client-desktop)** this repo and **Watch** for release notifications!
