...
NOTE: Starting with {ini_name} version 7.0, the Desktop App no longer supports ownCloud server but only ownCloud Intinite Scale. To use the Desktop App with ownCloud server, please use version 6.0 or higher.
