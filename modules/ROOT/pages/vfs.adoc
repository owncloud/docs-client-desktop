...
. When done, your files will be fully downloaded, which you can tell by the sync icons. Depending on the quantity and size of the files, this may take a while.
