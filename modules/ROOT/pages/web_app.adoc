...
image::web_app/office_file_in_browser.png[file in browser, width=350]

This file gets synced by the Desktop App and is locally available.

image::web_app/office_file_in_explorer.png[file in explorer, width=350]
...
image::web_app/office_file_context_menu.png[file context menu, width=350]
...
image::web_app/office_file_in_web_app.png[file in web app, width=350]
