...
:toc: right
:toclevels: 4
:client-version-win: 5.3.0.13987.x64
:client-version-appimage: 5.3.0.13987-x86_64
...
** Ubuntu 23.04
** Ubuntu 22.04 LTS
* An **xref:appimage[AppImage]** build of the ownCloud Desktop App is available to support more Linux platforms
|===
