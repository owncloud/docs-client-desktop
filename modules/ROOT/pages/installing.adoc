...
:toc: right
:toclevels: 4
:client-version: 4.0.0.10896-x86_64
...
----
wget {client-download-url}{url-version}/linux-appimage/ownCloud-{client-version}.AppImage
----
...
[source,bash,subs="attributes+"]
----
sudo chmod +x ownCloud-{client-version}.AppImage
----
...
[source,bash,subs="attributes+"]
----
~/Applications/ownCloud-{client-version}.AppImage
----
...
If you just want to install the ownCloud Desktop App on your local system, you can simply {client-download-url}{url-version}/win/[download,window=_blank] and launch the `.msi` file and configure it in the wizard that pops up.
...
----
msiexec /passive /i ownCloud-{client-version}.msi
----
...
[source,console,subs="attributes+"]
----
msiexec /passive /i ownCloud-{client-version}.msi REMOVE=DesktopShortcut
----
...
[source,console,subs="attributes+"]
----
msiexec /passive /i ownCloud-{client-version}.msi ADDDEFAULT=Client
----
...
[source,console,subs="attributes+"]
----
msiexec /passive /i ownCloud-{client-version}.msi ADDDEFAULT=StartMenuShortcuts
----
...
[source,console,subs="attributes+"]
----
msiexec /passive /i ownCloud-{client-version}.msi NO_DESKTOP_SHORTCUT="1"
...
[source,console,subs="attributes+"]
----
msiexec /passive /i ownCloud-{client-version}.msi ADDDEFAULT="DesktopShortcut"
----
...
[source,console,subs="attributes+"]
----
msiexec /passive /i ownCloud-{client-version}.msi INSTALLDIR="C:\Program Files (x86)\Non Standard ownCloud Client Folder"
----
...
[source,console,subs="attributes+"]
----
msiexec /passive /i ownCloud-{client-version}.msi SKIPAUTOUPDATE="1"
----
...
[source,console,subs="attributes+"]
----
msiexec /i ownCloud-{client-version}.msi LAUNCH="1"
----
...
[source,console,subs="attributes+"]
----
msiexec /i ownCloud-{client-version}.msi REBOOT=ReallySuppress
----
...
[source,console,subs="attributes+"]
----
msiexec /i ownCloud-{client-version}.msi DO_NOT_SCHEDULE_REBOOT="1"
----
...
[source,console,subs="attributes+"]
----
msiexec /i ownCloud-{client-version}.msi /L*V "C:\log\example.log"
----
