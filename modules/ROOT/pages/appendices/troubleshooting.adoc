...
The macOS installer brings it's own Log console. Just run the *.PKG as usual At the first install screen in the menu bar click Window --> Installer Log (Command + L)

[width=100%,cols="50%,50%"]
|===
a| image::appendices/troubleshooting/log-install-macos1.png[macOS Installer Enable Logging,width=250]
a| image::appendices/troubleshooting/log-install-macos2.png[macOS Installer Log View,width=450]
|===
