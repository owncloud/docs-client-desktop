...
There are very rare cases when using Windows and VFS, that the Desktop app complains about denied access containing in the log following message, including the source file for reference:
...
If the permission is not set to `Full Control`, you can either correct it or ask you administrator for support.
