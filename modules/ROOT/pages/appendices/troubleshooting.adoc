...
The macOS installer brings its own log console. Just run the *.PKG as usual. At the first install screen in the menu bar, click Window --> Installer Log (Command + L).
