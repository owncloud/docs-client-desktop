...
NOTE: Change the ownership of `paths.ini` to make it readable for the user.
...
NOTE: Before running middleware, install yarn following the instructions from {yarn-install-url}[here].
