...
image:using/oc-wizard-screen-advanced.png[Select which remote folders to sync, and which local folder to store them in, width=100]
--

Final step::
+
--
Once you are satisfied with the configuration made, click the btn:[Finish] button at the bottom right. The Desktop App will attempt to connect to your {ini_name} server.
--
