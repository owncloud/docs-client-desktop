...
You can configure multiple accounts in your Desktop App. Just click on the menu:Account[Add New] button at the top left and follow the xref:connection-wizard[Connection Wizard]. The new account will appear as a new item in the main window at the top.

=== Removing an Account

To remove an account, select the account you want to remove and click the menu:Account[Remove] button to remove it. Note that the account will be removed but no synchronized data deleted.
