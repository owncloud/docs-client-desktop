...
You can share with internal ownCloud users and groups respectively create links to share with external users.
...
* Right-click the file or folder you want to share to expose the share dialog which openes the context menu, and click menu:ownCloud[Share].
+
